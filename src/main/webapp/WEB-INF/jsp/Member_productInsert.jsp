...
<div class="i_bg bg_color">
	...
	<div class="m_content">
            ...
            <div class="left_m">
             ...
             <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="Member_Collect.html">分类管理</a></li>
                    <li><a href="Member_Msg.html" >商品管理</a></li>
                    <li><a href="Member_Links.html"  class="now">商品上架</a></li>
                </ul>
            </div>
            <div class="left_m">
        ...
        <!-- 修改内容 -->
		<div class="m_right">
            <p><input type="button" id="btn1" value="Test"></p>
            <div class="mem_tit">
            	<span class="fr" style="font-size:12px; color:#55555; font-family:'宋体'; margin-top:5px;"></span>商品上架
            </div>
            <form id="insertform" method="post" >
	           	<table border="1" class="order_tab" style="width:60%;" cellspacing="0" cellpadding="0">
	              	...
	              	<tr>
	              		...
	              		<td width="60%"><input type="text" name="name">(必填)</td>
	              	</tr>
	              	<tr>
	              		<td align="right" width="40%">商品图片</td>
	              		<td width="60%"><input type="file" name="fileName"></td>
	              	</tr>
					<tr>
					...
					<tr>
	              	...
	              	<tr>
	              		...
	              		<td width="60%"><input type="button" value="确认新增" id="btn">
    ...
    <!--End Footer End -->    
     ...
     <script type="text/javascript" src="${pageContext.request.contextPath}/jquery/productInsert.js"></script> 
	<input type="button" id="lcw"/>
</body>
