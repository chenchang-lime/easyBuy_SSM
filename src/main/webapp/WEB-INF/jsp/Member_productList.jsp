...
<title>【转转】商城-商品管理</title>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.8.2.min.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/menu.js"></script>    
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/select.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/jquery/productList.js"></script>
</head>
<body>  
<!--Begin Header Begin-->
<div class="soubg">
...
<div class="i_bg bg_color">
 ...
 <!-- 修改内容 -->
		<div class="m_right">
            <p></p>
            <div class="mem_tit">
            	<span class="fr" style="font-size:12px; color:#55555; font-family:'宋体'; margin-top:5px;">共发现<span  id="count" style=color:red></span>件</span>商品列表
          	</div>
          <div id="showList">
              ...
              <thead>
	              <tr>                                                                                                                                       
	                ...
	                <td align="center" width="220px">商品图片</td>
	                <td align="center" width="120px">库存</td>
	                <td align="center" width="180px">价格</td>
	                <td align="center" width="270px" colspan="2">操作</td>
	              </tr>
              </thead>
              <tbody id="tb">
        ...
        <div id="showUpdate">
        	 <form id="myform" >
	           	<table border="1" style="width:60%;" class="order_tab" cellspacing="0" cellpadding="0">
	              	<tr>
	              		<td align="right" width="40%">一级分类</td>
	              		<td width="60%"><select id="firstType" name="categoryLevel1Id"><option value='-1'>请选择</option></select></td>
	              	</tr>
	              	<tr>
	              		<td align="right" width="40%">二级分类</td>
	              		<td width="60%"><select id="secendType" name="categoryLevel2Id"><option value='-1'>请选择</option></select></td>
	              	</tr>
	              	<tr>
	              		<td align="right" width="40%">三级分类</td>
	              		<td width="60%"><select id="thirdType" name="categoryLevel3Id"><option value='-1'>请选择</option></select></td>
	              	</tr>
	              	<tr>
	              		<td align="right" width="40%">商品名称</td>
	              		<td width="60%">
	              		<input type="hidden" name="id" id="proid">
	              		<input type="text" name="name">(必填)</td>
	              	</tr>
	              	<tr>
	              		<td align="right" width="40%">商品图片</td>
	              		<td width="60%">
	              			<input type="hidden" name="fileName">
							<img alt="" src="" width="100px" height="100px" id="image">
							<img alt="" src="" width="100px" height="100px" id="image1">
					...
					<tr>
	              		<td align="right" width="40%">库存</td>
	              		<td width="60%"><input type="text" name="stock"></td>
	              	</tr>
					<tr>
	              		<td align="right" width="40%">描述</td>
	              		<td width="60%"><textarea rows="10" cols="30" name="description"></textarea></td>
	              	</tr>
	              	<tr>
	              		<td align="right" width="40%"></td>
	              		<td width="60%"><input type="button" value="确认修改" id="btn">
	              		</td>
	              	</tr>
	            </table>
	           </form>
