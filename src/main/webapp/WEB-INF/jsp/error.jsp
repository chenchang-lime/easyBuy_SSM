...
.error_left {
	...
	width: 330px;
	height: 345px;
	background: url(/easyBuy_SSM/images/timg.png) no-repeat;
	background-size: 100%;
	float: left;
}
	...
	<div class="error_content">
		...
		<div class="error_right">
			<div class="error_detail">
				...
				<p class="error_p_con">●您可致电15926433002,通知开发人员!</p>
				<p class="error_p_con">●易买网的进步需要您的反馈,感谢您对易买网的使用,请您耐心等待!</p>
			</div>
			<div class="btn_error">
				<a class="btn_back1" href="/easyBuy_SSM/page/index">返回首页</a>
