    	...
    	<div class="two_bg">
            ...
            <table border="0" class="peo_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="395" id="userName">${thisOrder.loginName}</td>
                <td class="p_td" width="160">创建时间</td>
                <td width="395" id="email">
                	<fmt:formatDate value="${thisOrder.createTime}" pattern="yyyy/MM/dd  HH:mm:ss" />
                </td>
              </tr>
              <tr>
