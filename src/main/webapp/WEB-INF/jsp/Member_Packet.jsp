...
<script type="text/javascript" 
	src="${pageContext.request.contextPath}/jquery/logout.js"></script>
<script type="text/javascript" 
	src="${pageContext.request.contextPath}/jquery/util.js"></script>
<title>【转转】商城-新闻管理</title>
</head>
<body>
	<!--Begin Header Begin-->
		...
		<div class="sou">
			...
			<c:if test="${empty account}">
				...
				class="fr">|&nbsp;<a href="#">手机版&nbsp;<img
						src="${pageContext.request.contextPath}/images/s_tel.png"
	...
	<div class="m_top_bg">
		<div class="top">
			<div class="m_logo">
				<a href="${pageContext.request.contextPath}/page/index"><img
	...
	<div class="i_bg bg_color">
        ...
        <!-- -----------------------------最高权限管理员----------------------------- -->
			...
			<div class="m_right">
            	...
            	<span class="m_num fr" style="margin-top:15px;"><a onclick="fanhui()" href="javascript:void(0);">返回</a></span>新闻中心
            </div>
		...
		<div class="b_btm_bg b_btm_c">
			<div class="b_btm">
				<table border="0"
					...
					<tr>
						<td width="72"><img
							src="${pageContext.request.contextPath}/images/b1.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					<tr>
						<td width="72"><img
							src="${pageContext.request.contextPath}/images/b2.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					<tr>
						<td width="72"><img
							src="${pageContext.request.contextPath}/images/b3.png" width="62"
							height="62" /></td>
				...
				<table border="0"
					...
					<tr>
						<td width="72"><img
							src="${pageContext.request.contextPath}/images/b4.png" width="62"
							height="62" /></td>
		...
		<div class="b_nav">
			...
			<div class="b_er">
				<div class="b_er_c">
					<img src="${pageContext.request.contextPath}/images/er.gif"
		...
		<div class="btmbg">
			<div class="btm">
				...
				<img src="${pageContext.request.contextPath}/images/b_1.gif"
					width="98" height="33" /><img
					src="${pageContext.request.contextPath}/images/b_2.gif" width="98"
					height="33" /><img
					src="${pageContext.request.contextPath}/images/b_3.gif" width="98"
					height="33" /><img
					src="${pageContext.request.contextPath}/images/b_4.gif" width="98"
					height="33" /><img
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery/isLoginType5.js"></script>
</body>
</html>
