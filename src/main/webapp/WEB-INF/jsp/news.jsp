...
<body>
	...
	<table border="0" style="width:880px; margin-top:20px;"  cellspacing="0" cellpadding="0">
              <tr height="45">
                ...
                <td>
                	<input type="text" id="tou" value="${lxNew.title}" class="add_ipt" style="width:290px;" readonly="readonly" />
                </td>
              </tr>
              <tr valign="top">
                <td align="right">新闻内容 &nbsp; &nbsp;</td>
                <td style="padding-top:5px;">
	                <textarea class="add_txt" id="neirong" readonly="readonly" rows="120" style="margin: 0px; width: 691px; height: 350px;">
						${lxNew.content}
                	</textarea>
                </td>
              </tr>
              <tr height="50" valign="bottom">
                <td>&nbsp;</td>
                <td><a href="/easyBuy_SSM/page/index"><input type="button" value="返回" class="btn_tj" /></a></td>
              </tr>
            </table>
