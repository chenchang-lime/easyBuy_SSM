	...
	<div class="m_content">
		...
		<div class="m_right">
            ...
            <table border="0" class="order_tab" style="width:930px; text-align:center; margin-bottom:30px;" cellspacing="0" cellpadding="0">
              <tr>                                                                                                                                                    
                <td width="30%" style="width:200px">订单号</td>
                <td width="25%">下单时间</td>
              ...
              <tr>
              	<td colspan="5" align="right">
              		<a href="javascript:void(0)" id="lastPage"><font color='#ff4e00'>上一页</font></a>&nbsp;&nbsp;
	              		第<span><font color='#ff4e00' id="pageNum">1</font></span>页
	              		&nbsp;/&nbsp;
	              		共<span><font color='#ff4e00' id="totalPage">1</font></span>页&nbsp;&nbsp;
              		<a href="javascript:void(0)" id="nextPage"><font color='#ff4e00'>下一页</font></a>
              	</td>
              </tr>
            </table>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jquery/selectMyOrders.js"></script>
