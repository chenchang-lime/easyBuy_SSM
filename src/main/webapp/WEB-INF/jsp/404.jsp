...
body {background:url(/easyBuy_SSM/images/b1.jpg)}
.mian {width:1000px;height:600px;background:url(/easyBuy_SSM/images/back.jpg);margin:3% auto}
...
<script type="text/javascript">
	    ...
	    function SetRemainTime() {
           if (curCount == 0) {
               ...
               window.setTimeout("window.location='/easyBuy_SSM/page/index'",0); 
           }
           else {
               curCount--;
...
<div class="mian">
	<div class="error_div">
        <a href="/easyBuy_SSM/page/index">返回首页</a>
        <p id="redirect_info" class="info">3秒后返回首页</p>
        <script type="text/javascript">
            curCount=count;
