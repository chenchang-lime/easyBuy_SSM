...
/**
 * 表名：easybuy_product_category 商品类型表
 * 
 * @author 陈昌
 */
public class ProType {
	 ...
	 *            类型图标（图片名称）
	 */
	public ProType(Integer id, String name, Integer parentId, Integer type, String iconClass, String englishName) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		return "ProType [id=" + id + ", name=" + name + ", parentId=" + parentId + ", type=" + type + ", iconClass="
				+ iconClass + ", englishName=" + englishName + "]";
	}
